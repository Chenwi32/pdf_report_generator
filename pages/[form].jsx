import { Box, Button, Container, FormControl, HStack, Heading, Input, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, SimpleGrid, Text, VStack, useDisclosure } from "@chakra-ui/react";
...
const Form = (props) => {
  ...
  return (
    <>
      ...
      <Container maxW={1200} ref={ref}>
        <Heading>Student Report</Heading>
