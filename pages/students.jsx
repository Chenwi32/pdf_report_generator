import { Button, Container, Flex, HStack, Heading, Input, Table, TableContainer, Tbody, Td, Text, Th, Thead, Tr, VStack } from "@chakra-ui/react";
      ...
      <Container ref={ref} maxW={1200}>
        ...
        {classStudents.length === 0 ? (
          <Heading fontSize={"1rem"}>
            Sorry no students have been registered in this class Yet
          </Heading>
        ) :
